...
namespace kli4ki
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		{ Group ob=new Group();
			int k=0;
			for (int i=0;i<4;i++)
			 if ( ob.Register[i].Name== textBox1.Text)
				 k=i;
			label2.Text="имя "+ob.Register[k].Name+ " номер владельца "+ob.Register[k].Nomer;
			if ((ob.Register[k].check())!=0) label3.Text= "отдел регестрации"+ ob.Register[k].N;
		}
